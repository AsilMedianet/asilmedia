<?php
ob_start();
define('API_KEY', '1182204863:AAHimlk1hwOdd5Ln6gecftQu1ZFzuABIe8o');
$admin = "415131571"; 
...
$botim="yordam_beruvchi_admin_bot";
...
$sta = bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=> "Salom ,mening ismim <b>Yordamchi</b>.\n\nMen AsilMedia.net saytining chatlarini nazorat qiluvchi maxsus botiman.",
'parse_mode' => 'html',
'disable_web_page_preview'=>true,
  'reply_markup'=>json_encode([   
   'inline_keyboard'=>[   
       [['text'=>'Buyruqlar', 'callback_data' => "stat"],['text'=>'Statistika', 'callback_data' => "stat1"]],
          [['text'=>'Rasmiy kanal #1','url'=>'telegram.me/https://telegram.me/joinchat/AAAAAEnP4ZbQ_Nslc0FWxg'],['text'=>'Rasmiy kanal #2','url'=>'telegram.me/asilmedia_net']],
             [['text'=>'Guruhga qo‘shish','url'=>'telegram.me/$botim?startgroup=new']]
]   
]),
]);
}
...
<b>Unban</b> - “Ban”dan oladi;
<b>Pin</b> - Xabarni yuqoriga qistiradi;
<b>Addpm</b> - Guruh a‘zosini guruhga admin qiladi;
<b>Delpm</b> - Guruh a'zosini adminlikdan oladi.
<b>#admin</b> heshtegidan so'ng so'z yozib yuboring va xabaringiz administratorlarga yetkaziladi.",
'parse_mode' => 'html',
'disable_web_page_preview'=>true,
'reply_markup'=>json_encode(
['inline_keyboard' => [
...
if($text1 == "/buyruqlar" or $text1 == "/buyruqlar@xxxxxxxxx"){
if($cty == "supergroup" or $cty == "group"){
  bot('sendChatAction',['chat_id'=>$chat_id,'action'=>"typing"]);
$bs = bot('sendMessage',[
'chat_id'=>$chat_id,
...
[['url' => 'https://telegram.me/$botim?startgroup=new', 'text' => "Guruhga qo‘shish"],],
    ...
    if($text1 == "admin"){
      bot('sendmessage',[
        ...
        'reply_markup'=>json_encode([   
        'inline_keyboard'=>[   
            [['text'=>'✔️Admin', 'callback_data' => "admin"]]
]   
]),
]);
}
...
if((mb_stripos($mtext,"#admin") !== false) or (mb_stripos($mtext,"admin")!==false) or (stripos($mtext,"Asilbek")!==false) or (mb_stripos($mtext,"administrator")!==false) or (mb_stripos($mtext,"asilmedia")!==false)){ 
bot('SendMessage',[
'chat_id'=>$admin,
'parse_mode'=>'html',
...
<b>Usernamesi:</b> @$username ", null, false
  ...
  bot('sendmessage', [
      'chat_id' => $chat_id,
      'text' => "<a href='tg://user?id=$useid'>Foydalanuvchi</a> -$chatidsi guruhida <b>$vaqti</b> ga <b>Read only</b> rejimiga tushirildi!",
      'parse_mode' => 'html'
  ]);
}
